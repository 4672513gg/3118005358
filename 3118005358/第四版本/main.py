...
def cal_result (doc1,doc2):
    ...
    # 输出结果写入指定文档
    with open('1.txt','w',encoding='UTF-8',errors='ignore') as f3:
...
if __name__ == '__main__':
    ...
    # 文件操作
    try:
        with open(text1_abs_path, 'r', encoding='UTF-8',errors='ignore') as f1, open(text2_abs_path, 'r', encoding='UTF-8',errors='ignore') as f2:

            # 读取文件内容
            doc1 = f1.read()
            doc2 = f2.read()

            # 过滤非中文，对文本中的非中文内容等进行删去
    ...
    # 将经处理的文本1，文本2 jieba 分词，转向量，返回计算结果
    calculation=cal_result(doc1,doc2)
